...
const FollowUs = () => {
  return (
    <div className="flex justify-around items-center text-[8rem] bg-stone-950 text-white overflow-hidden py-9">
      <span className="flex shrink-0 space-x-1 items-center">
        Follow Us{" "}
        <AiFillTwitterCircle className="text-8xl text-stone-300 mx-9" />
      </span>
      <span className="flex shrink-0 space-x-1 items-center">
        Follow Us{" "}
